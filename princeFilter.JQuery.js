        ...
        if ($(thisElement)[0] != null) {
            if ($(thisElement)[0].rows.length > 0) {
                ...
                if ($('#dv_prncFltr_FilterSettings')[0] == null) {
                    ...
                    var xOpss =  "<option value=\"like\">like</option>";
                $('#cmb_prncFltr_FilterSettings').append(xOpss);

                    $('#cmb_prncFltr_FilterSettings').on('change', function (eva) {
                        var cOperand = 'like';    //$('#cmb_prncFltr_FilterSettings option:selected').val();
                    ...
                    $('#btn_prncFltr_FilterSettings_Apply').on('click', function () { //Bouton apply
                        var xApplF_val = 'like'//$('#cmb_prncFltr_FilterSettings option:selected').val();
                        if (xApplF_val == '(none)') {
                    ...
                    $('#btn_prncFltr_FilterSettings_Reset').on('click', function () { //BOuton clear
                        $('#' + $('#btn_prncFltr_FilterSettings_Apply').attr('sourceTxt')).val('');
                        $('#' + $('#btn_prncFltr_FilterSettings_Apply').attr('sourceBtn')).css('opacity', '0.4');
